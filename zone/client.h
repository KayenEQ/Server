...
public:
	...
	*/
	...
	int32 GetActSpellHealing(uint16 spell_id, int32 value, Mob* target = nullptr, int16 buff_focus = 0); //C!Kayen
	...
	int32 GetActDoTDamage(uint16 spell_id, int32 value, Mob* target = nullptr, int16 buff_focus = 0); //C!Kayen
