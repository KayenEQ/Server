...
struct StatBonuses {
	...
	int32   Luck_Amount;						// Total Amount of Luck
	//int32   Luck_PowerMod;						// Increases potency of Luck affect (Set to improve baseline mod values by pct)
	int32	Luck_Percent;						// Chance to have a lucky affect
