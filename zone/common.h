...
#define ABILITY_SPELL_SLOT 90 //C!Kayen
...
struct StatBonuses {
	...
	int16 IncommingMeleeDmgToHP;				// Pct
	int16 IncommingMeleeDmgToMana;				// Pct
	int16 IncommingMeleeDmgToEndur;				// Pct
