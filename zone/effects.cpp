...
int32 Mob::GetActSpellDamage(uint16 spell_id, int32 value, Mob* target) {
	...
	value_BaseEffect = GetBaseSpellPower(value_BaseEffect,spell_id, true); //C!Kayen DD
...
int32 Mob::GetActDoTDamage(uint16 spell_id, int32 value, Mob* target, int16 buff_focus) {
...
int32 Mob::GetActSpellHealing(uint16 spell_id, int32 value, Mob* target, int16 buff_focus) {
