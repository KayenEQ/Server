...
#define SE_AdjustRecastTimer			1007 // implemented - Sets Recast Timer to end early for specified spells. (B: Amt Time Reduced L: Refresh Spell M: )
...
#define SE_UtilityDisplayGFX			1100 // implemented - Base - Spell ID number of rain graphic display or target ring location
...
bool GetDiscLimitToFlank(uint16 spell_id);
int GetDiscHPRestriction(uint16 spell_id);
bool GetEffectLimitToBehind(uint16 spell_id);
bool GetEffectLimitToFront(uint16 spell_id);
bool GetEffectLimitToFlank(uint16 spell_id);
//Projectile Hacks
