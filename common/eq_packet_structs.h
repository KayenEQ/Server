...
static const uint32 MAX_PP_MEMSPELL = 10; // Set to latest client so functions can work right //C!Kayen [+1]
static const uint32 MAX_PP_REF_SPELLBOOK = 480;	// Set for Player Profile size retain
static const uint32 MAX_PP_REF_MEMSPELL = 10; // Set for Player Profile size retain //C!Kayen [+1]
